      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-6">Mevcut Yazılar ({posts.length})</h2>
            {posts.length === 0 ? (
              ...
              posts.map(post => (
                <div key={post.id} className="glass-card p-5 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-900 dark:text-white text-lg line-clamp-1">{post.title}</h3>
