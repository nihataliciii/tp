        ...
        <div className="glass-card p-7 md:p-9 relative z-20" style={{ border: '1px solid var(--border-accent)' }}>
          ...
          {mode === 'forgot_password' && (
            <div className="mb-8 text-center animate-fade-in-up">
              ...
              <h2 className="text-2xl font-bold text-slate-700 dark:text-white gradient-text">{t(language, 'resetPassTitle')}</h2>
            </div>
          )}
            ...
            {mode === 'signup' && (
              <div className="flex flex-col gap-5 animate-fade-in-up">
                <div className="relative group">
                  ...
                  <input
                    className="input-field bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900 transition-all text-slate-700 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 font-medium h-14"
              ...
              <div className="flex flex-col items-end animate-fade-in-up">
                <div className="relative w-full group">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-700 dark:text-slate-500 dark:hover:text-white transition-colors p-1"
                  >
