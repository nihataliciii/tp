      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
            ...
            <div className="flex gap-6">
              {[
                ...
                <div key={stat.label} className="text-center">
                  <p className="text-3xl font-black text-white" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>{stat.value}</p>
        ...
        >
          ...
          <div className="flex-1">
            <p className="font-bold text-white text-base">{isTR ? 'Forum Yakında Açılıyor' : 'Forum Coming Soon'}</p>
