    ...
    <div className="relative min-h-[calc(100vh-80px)] w-full overflow-x-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h1
            className="text-5xl md:text-7xl font-black text-slate-700 dark:text-white mb-6 uppercase"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-700 dark:text-white mb-1">{isTR ? 'E-posta' : 'Email'}</h3>
            ...
            <div className="glass-card p-8 flex items-start gap-5">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-700 dark:text-white mb-2">{isTR ? 'Yanıt Süresi' : 'Response Time'}</h3>
            ...
            <div className="glass-card p-8 flex items-start gap-5">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-700 dark:text-white mb-2">{isTR ? 'Konum' : 'Location'}</h3>
                <p className="text-[var(--text-secondary)] text-base leading-relaxed">
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[var(--accent-purple)] to-[var(--accent-cyan)] flex items-center justify-center shadow-[0_0_30px_rgba(124,58,237,0.4)]">
                <Mail size={36} className="text-slate-700 dark:text-white" />
              </div>
              <div>
                <h2
                  className="text-3xl font-black text-slate-700 dark:text-white mb-3 uppercase"
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-slate-700 dark:text-white mb-1">{isTR ? 'Topluluk Forumu' : 'Community Forum'}</h3>
