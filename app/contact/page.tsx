        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-1">{isTR ? 'E-posta' : 'Email'}</h3>
            ...
            <div className="glass-card p-8 flex items-start gap-5">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">{isTR ? 'Yanıt Süresi' : 'Response Time'}</h3>
            ...
            <div className="glass-card p-8 flex items-start gap-5">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">{isTR ? 'Konum' : 'Location'}</h3>
                <p className="text-[var(--text-secondary)] text-base leading-relaxed">
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-white mb-1">{isTR ? 'Topluluk Forumu' : 'Community Forum'}</h3>
